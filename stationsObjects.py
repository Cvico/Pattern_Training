...
SLgap_MB4 = 29 - globalDTheight*12
...
ll1f = Layer(-30.*globalDTwidth,                   4*globalDTheight + SLgap_MB4, nDTMBTrain+62, idx=5, offset=30)
ll2f = Layer(-29.5*globalDTwidth,                  5*globalDTheight + SLgap_MB4, nDTMBTrain+62, idx=6, offset=30)
ll3f = Layer(-30.*globalDTwidth,                   6*globalDTheight + SLgap_MB4, nDTMBTrain+62, idx=7, offset=30)
ll4f = Layer(-29.5*globalDTwidth,                  7*globalDTheight + SLgap_MB4, nDTMBTrain+62, idx=8, offset=30)
